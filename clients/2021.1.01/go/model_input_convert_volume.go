...
// InputConvertVolume struct for InputConvertVolume
type InputConvertVolume struct {
...
func (o InputConvertVolume) MarshalJSON() ([]byte, error) {
...
type NullableInputConvertVolume struct {
	value *InputConvertVolume
	isSet bool
}

func (v NullableInputConvertVolume) Get() *InputConvertVolume {
	return v.value
}

func (v *NullableInputConvertVolume) Set(val *InputConvertVolume) {
	v.value = val
	v.isSet = true
}

func (v NullableInputConvertVolume) IsSet() bool {
	return v.isSet
}

func (v *NullableInputConvertVolume) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInputConvertVolume(val *InputConvertVolume) *NullableInputConvertVolume {
	return &NullableInputConvertVolume{value: val, isSet: true}
}

func (v NullableInputConvertVolume) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInputConvertVolume) UnmarshalJSON(src []byte) error {
	v.isSet = true
