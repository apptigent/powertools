...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InputCollectionConversionXML :  IEquatable<InputCollectionConversionXML>, IValidatableObject
    {
        ...
        public InputCollectionConversionXML(List<string> input = default(List<string>), string root = default(string), string child = default(string))
        {
            ...
            if (input == null)
            {
                throw new InvalidDataException("input is a required property for InputCollectionConversionXML and cannot be null");
            }
            else
            {
                this.Input = input;
            ...
            if (root == null)
            {
                throw new InvalidDataException("root is a required property for InputCollectionConversionXML and cannot be null");
            }
            else
            {
                this.Root = root;
            ...
            if (child == null)
            {
                throw new InvalidDataException("child is a required property for InputCollectionConversionXML and cannot be null");
            }
            else
            {
                this.Child = child;
