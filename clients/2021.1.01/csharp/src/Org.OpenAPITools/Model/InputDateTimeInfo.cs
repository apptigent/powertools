...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InputDateTimeInfo :  IEquatable<InputDateTimeInfo>, IValidatableObject
    {
        /// <summary>
        /// Language culture
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InputDateTimeInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InputDateTimeInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InputDateTimeInfo" /> class.
        /// </summary>
        ...
        public InputDateTimeInfo(string input = default(string), CultureEnum culture = CultureEnum.EnUS)
        {
            // to ensure "input" is required (not null)
            if (input == null)
            {
                throw new InvalidDataException("input is a required property for InputDateTimeInfo and cannot be null");
            }
            else
            {
                this.Input = input;
            ...
            if (culture == null)
            {
                throw new InvalidDataException("culture is a required property for InputDateTimeInfo and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as InputDateTimeInfo);
        }

        /// <summary>
        /// Returns true if InputDateTimeInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of InputDateTimeInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InputDateTimeInfo input)
        {
            if (input == null)
                return false;
