...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InputGenerateHash :  IEquatable<InputGenerateHash>, IValidatableObject
    {
        /// <summary>
        /// Hash algorithm
        /// </summary>
        ...
        public InputGenerateHash(string input = default(string), AlgorithmEnum algorithm = default(AlgorithmEnum))
        {
            ...
            if (input == null)
            {
                throw new InvalidDataException("input is a required property for InputGenerateHash and cannot be null");
            }
            else
            {
                this.Input = input;
            ...
            if (algorithm == null)
            {
                throw new InvalidDataException("algorithm is a required property for InputGenerateHash and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as InputGenerateHash);
        }

        /// <summary>
        /// Returns true if InputGenerateHash instances are equal
        /// </summary>
        /// <param name="input">Instance of InputGenerateHash to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InputGenerateHash input)
        {
            if (input == null)
                return false;
