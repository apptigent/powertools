...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InputCalculateSeries :  IEquatable<InputCalculateSeries>, IValidatableObject
    {
        ...
        public InputCalculateSeries(List<decimal> input = default(List<decimal>), decimal decimals = default(decimal))
        {
            ...
            if (input == null)
            {
                throw new InvalidDataException("input is a required property for InputCalculateSeries and cannot be null");
            }
            else
            {
                this.Input = input;
            ...
            if (decimals == null)
            {
                throw new InvalidDataException("decimals is a required property for InputCalculateSeries and cannot be null");
            }
            else
            {
