...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InputConvertEnergy :  IEquatable<InputConvertEnergy>, IValidatableObject
    {
        ...
        public InputConvertEnergy(decimal input = default(decimal), SourceEnum source = default(SourceEnum), TargetEnum target = default(TargetEnum))
        {
            ...
            if (input == null)
            {
                throw new InvalidDataException("input is a required property for InputConvertEnergy and cannot be null");
            }
            else
            {
                this.Input = input;
            ...
            if (source == null)
            {
                throw new InvalidDataException("source is a required property for InputConvertEnergy and cannot be null");
            }
            else
            {
                this.Source = source;
            ...
            if (target == null)
            {
                throw new InvalidDataException("target is a required property for InputConvertEnergy and cannot be null");
            }
            else
            {
                this.Target = target;
