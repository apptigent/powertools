...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InputJsonConversionXML :  IEquatable<InputJsonConversionXML>, IValidatableObject
    {
        ...
        public InputJsonConversionXML(string input = default(string), string root = default(string))
        {
            ...
            if (input == null)
            {
                throw new InvalidDataException("input is a required property for InputJsonConversionXML and cannot be null");
            }
            else
            {
                this.Input = input;
            ...
            if (root == null)
            {
                throw new InvalidDataException("root is a required property for InputJsonConversionXML and cannot be null");
            }
            else
            {
                this.Root = root;
