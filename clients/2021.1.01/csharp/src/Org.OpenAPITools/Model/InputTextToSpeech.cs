...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InputTextToSpeech :  IEquatable<InputTextToSpeech>, IValidatableObject
    {
        ...
        public InputTextToSpeech(string text = default(string), TypeEnum type = TypeEnum.PlainText, VoiceEnum voice = VoiceEnum.EnUSAriaFemale)
        {
            ...
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for InputTextToSpeech and cannot be null");
            }
            else
            {
                this.Text = text;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for InputTextToSpeech and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (voice == null)
            {
                throw new InvalidDataException("voice is a required property for InputTextToSpeech and cannot be null");
            }
            else
            {
                this.Voice = voice;
