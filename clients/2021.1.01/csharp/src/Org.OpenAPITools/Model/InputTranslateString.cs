...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InputTranslateString :  IEquatable<InputTranslateString>, IValidatableObject
    {
        ...
        public InputTranslateString(string input = default(string), LanguageEnum language = default(LanguageEnum))
        {
            ...
            if (input == null)
            {
                throw new InvalidDataException("input is a required property for InputTranslateString and cannot be null");
            }
            else
            {
                this.Input = input;
            ...
            if (language == null)
            {
                throw new InvalidDataException("language is a required property for InputTranslateString and cannot be null");
            }
            else
            {
