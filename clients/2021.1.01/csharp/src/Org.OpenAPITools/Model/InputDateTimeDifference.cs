...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InputDateTimeDifference :  IEquatable<InputDateTimeDifference>, IValidatableObject
    {
        ...
        public InputDateTimeDifference(string dateTime1 = default(string), string dateTime2 = default(string))
        {
            ...
            if (dateTime1 == null)
            {
                throw new InvalidDataException("dateTime1 is a required property for InputDateTimeDifference and cannot be null");
            }
            else
            {
            ...
            if (dateTime2 == null)
            {
                throw new InvalidDataException("dateTime2 is a required property for InputDateTimeDifference and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="dateTime1", EmitDefaultValue=true)]
        ...
        [DataMember(Name="dateTime2", EmitDefaultValue=true)]
