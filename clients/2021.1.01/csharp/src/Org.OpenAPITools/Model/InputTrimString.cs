...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InputTrimString :  IEquatable<InputTrimString>, IValidatableObject
    {
        ...
        public InputTrimString(string source = default(string), TypeEnum type = default(TypeEnum))
        {
            ...
            if (source == null)
            {
                throw new InvalidDataException("source is a required property for InputTrimString and cannot be null");
            }
            else
            {
                this.Source = source;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for InputTrimString and cannot be null");
            }
            else
            {
                this.Type = type;
