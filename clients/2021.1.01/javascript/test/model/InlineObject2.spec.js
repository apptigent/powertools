...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerToolsDeveloper.InlineObject2();
  });
  ...
  describe('InlineObject2', function() {
    it('should create an instance of InlineObject2', function() {
      ...
      //var instane = new PowerToolsDeveloper.InlineObject2();
      //expect(instance).to.be.a(PowerToolsDeveloper.InlineObject2);
    });

    it('should have the property source (base name: "source")', function() {
      // uncomment below and update the code to test the property source
      //var instance = new PowerToolsDeveloper.InlineObject2();
