...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerToolsDeveloper.InputCollectionSearch();
  });
  ...
  describe('InputCollectionSearch', function() {
    it('should create an instance of InputCollectionSearch', function() {
      // uncomment below and update the code to test InputCollectionSearch
      //var instane = new PowerToolsDeveloper.InputCollectionSearch();
      //expect(instance).to.be.a(PowerToolsDeveloper.InputCollectionSearch);
    });

    it('should have the property input (base name: "input")', function() {
      // uncomment below and update the code to test the property input
      //var instance = new PowerToolsDeveloper.InputCollectionSearch();
