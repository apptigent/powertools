...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowerToolsDeveloper.InputCollectionFilter();
  });
  ...
  describe('InputCollectionFilter', function() {
    it('should create an instance of InputCollectionFilter', function() {
      // uncomment below and update the code to test InputCollectionFilter
      //var instane = new PowerToolsDeveloper.InputCollectionFilter();
      //expect(instance).to.be.a(PowerToolsDeveloper.InputCollectionFilter);
    });

    it('should have the property input (base name: "input")', function() {
      // uncomment below and update the code to test the property input
      //var instance = new PowerToolsDeveloper.InputCollectionFilter();
