...
# Unit tests for OpenapiClient::InputDateTimeInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::InputDateTimeInfo do
  let(:instance) { OpenapiClient::InputDateTimeInfo.new }

  describe 'test an instance of InputDateTimeInfo' do
    it 'should create an instance of InputDateTimeInfo' do
      expect(instance).to be_instance_of(OpenapiClient::InputDateTimeInfo)
    end
  end
