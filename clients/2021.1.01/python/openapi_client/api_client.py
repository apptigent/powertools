...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.add_to_collection  # this is an instance of the class Endpoint
        api_instance.add_to_collection()  # this invokes api_instance.add_to_collection.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_to_collection.callable or self.callable in this class
