...
class InputCollectionSplit(ModelNormal):
    ...
    def __init__(self, input, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            match (str): String to match (explicit, case-insensitive, leave empty to use Index). [optional]  # noqa: E501
            index (str): Index location to split (leave empty to use Match value). [optional]  # noqa: E501
        """
