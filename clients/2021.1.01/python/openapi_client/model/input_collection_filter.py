...
class InputCollectionFilter(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, input, keywords, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            match (str): Match type. defaults to "Any", must be one of ["Any", "All", "None", ]  # noqa: E501
