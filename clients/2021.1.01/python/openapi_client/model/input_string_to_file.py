...
class InputStringToFile(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, input, filename, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            extension (str): File extension. defaults to "TXT", must be one of ["TXT", "CSV", "HTML", "XML", "CSS", "JSON", "JS", ]  # noqa: E501
