...
class InputCollectionSearchNumeric(ModelNormal):
    ...
    def __init__(self, input, match, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            type (str): Type of number - integer or decimal. [optional] if omitted the server will use the default value of "Integer"  # noqa: E501
        """
