...
/**
 * InputSplitString Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InputSplitString implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inputSplitString';
     ...
     * Sets characters
     *
     * @param string $characters One or more characters that will be used to split the text
     *
     * @return self
     */
