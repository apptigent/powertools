...
/**
 * InputDateTimeDifference Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InputDateTimeDifference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inputDateTimeDifference';
    ...
    {
        $this->container['date_time1'] = $data['date_time1'] ?? null;
        $this->container['date_time2'] = $data['date_time2'] ?? null;
    }
     ...
     * Sets date_time1
     *
     * @param string $date_time1 First date/time value
     *
     * @return self
     */
     ...
     * Sets date_time2
     *
     * @param string $date_time2 Second date/time value
     *
     * @return self
     */
