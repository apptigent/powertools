...
/**
 * InputTranslateString Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InputTranslateString implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inputTranslateString';
    ...
    const LANGUAGE_CHINESE__SIMPLIFIED = 'Chinese (Simplified)';
    ...
    const LANGUAGE_KLINGON = 'Klingon';
    const LANGUAGE_KOREAN = 'Korean';
    const LANGUAGE_NORWEIGAN = 'Norweigan';
    ...
    public function getLanguageAllowableValues()
    {
        return [
            ...
            self::LANGUAGE_CHINESE__SIMPLIFIED,
            self::LANGUAGE_CZECH,
            ...
            self::LANGUAGE_KLINGON,
            self::LANGUAGE_KOREAN,
            self::LANGUAGE_NORWEIGAN,
     ...
     * Sets input
     *
     * @param string $input String containing the text to be translated
     *
     * @return self
     */
