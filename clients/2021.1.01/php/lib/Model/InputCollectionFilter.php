...
/**
 * InputCollectionFilter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InputCollectionFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inputCollectionFilter';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['match'] = $data['match'] ?? 'Any';
     ...
     * Sets input
     *
     * @param string[] $input Collection of strings to filter
     *
     * @return self
     */
     ...
     * Sets keywords
     *
     * @param string $keywords Keywords (separate multiple values with commas)
     *
     * @return self
     */
