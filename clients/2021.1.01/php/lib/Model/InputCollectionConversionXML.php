...
/**
 * InputCollectionConversionXML Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InputCollectionConversionXML implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inputCollectionConversionXML';
     ...
     * Sets input
     *
     * @param string[] $input Collection containing strings to convert
     *
     * @return self
     */
     ...
     * Sets root
     *
     * @param string $root Name of root XML node
     *
     * @return self
     */
     ...
     * Sets child
     *
     * @param string $child Name of child XML node(s)
     *
     * @return self
     */
