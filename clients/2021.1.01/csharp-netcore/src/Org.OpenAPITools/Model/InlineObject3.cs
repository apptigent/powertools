...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject3 : IEquatable<InlineObject3>, IValidatableObject
    {
        ...
        public InlineObject3(string source = default(string))
        {
            // to ensure "source" is required (not null)
            this.Source = source ?? throw new ArgumentNullException("source is a required property for InlineObject3 and cannot be null");
        }
