...
namespace Org.OpenAPITools.Model
{
    ...
    /// InputDataQuery
    /// </summary>
    [DataContract(Name = "inputDataQuery")]
    public partial class InputDataQuery : IEquatable<InputDataQuery>, IValidatableObject
    {
        ...
        public InputDataQuery(string input = default(string), string query = default(string))
        {
            ...
            this.Input = input ?? throw new ArgumentNullException("input is a required property for InputDataQuery and cannot be null");
            // to ensure "query" is required (not null)
            this.Query = query ?? throw new ArgumentNullException("query is a required property for InputDataQuery and cannot be null");
        }
