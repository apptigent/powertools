...
namespace Org.OpenAPITools.Model
{
    ...
    /// InputStringContains
    /// </summary>
    [DataContract(Name = "inputStringContains")]
    public partial class InputStringContains : IEquatable<InputStringContains>, IValidatableObject
    {
        ...
        public InputStringContains(string find = default(string), string input = default(string), LowerEnum lower = default(LowerEnum))
        {
            ...
            this.Find = find ?? throw new ArgumentNullException("find is a required property for InputStringContains and cannot be null");
            // to ensure "input" is required (not null)
            this.Input = input ?? throw new ArgumentNullException("input is a required property for InputStringContains and cannot be null");
            this.Lower = lower;
        }
