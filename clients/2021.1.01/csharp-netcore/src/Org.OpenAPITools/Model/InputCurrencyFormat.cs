...
namespace Org.OpenAPITools.Model
{
    ...
    /// InputCurrencyFormat
    /// </summary>
    [DataContract(Name = "inputCurrencyFormat")]
    public partial class InputCurrencyFormat : IEquatable<InputCurrencyFormat>, IValidatableObject
    {
        /// <summary>
        /// Defines Target
        /// </summary>
        ...
        {
            return this.Equals(input as InputCurrencyFormat);
        }

        /// <summary>
        /// Returns true if InputCurrencyFormat instances are equal
        /// </summary>
        /// <param name="input">Instance of InputCurrencyFormat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InputCurrencyFormat input)
        {
            if (input == null)
                return false;
