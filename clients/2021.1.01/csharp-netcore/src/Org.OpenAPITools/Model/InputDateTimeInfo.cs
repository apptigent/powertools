...
namespace Org.OpenAPITools.Model
{
    ...
    /// InputDateTimeInfo
    /// </summary>
    [DataContract(Name = "inputDateTimeInfo")]
    public partial class InputDateTimeInfo : IEquatable<InputDateTimeInfo>, IValidatableObject
    {
        ...
        public InputDateTimeInfo(string input = default(string), CultureEnum culture = CultureEnum.EnUS)
        {
            ...
            this.Input = input ?? throw new ArgumentNullException("input is a required property for InputDateTimeInfo and cannot be null");
