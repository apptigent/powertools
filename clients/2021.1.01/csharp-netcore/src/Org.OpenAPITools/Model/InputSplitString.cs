...
namespace Org.OpenAPITools.Model
{
    ...
    /// InputSplitString
    /// </summary>
    [DataContract(Name = "inputSplitString")]
    public partial class InputSplitString : IEquatable<InputSplitString>, IValidatableObject
    {
        ...
        public InputSplitString(string input = default(string), string characters = default(string))
        {
            ...
            this.Input = input ?? throw new ArgumentNullException("input is a required property for InputSplitString and cannot be null");
            // to ensure "characters" is required (not null)
            this.Characters = characters ?? throw new ArgumentNullException("characters is a required property for InputSplitString and cannot be null");
        }
        ...
        [DataMember(Name = "characters", IsRequired = true, EmitDefaultValue = false)]
